...
<body>
	...
	<div class="menu_bg">
		<div class="menu">
			...
			<!--End 商品分类详情 End-->
			<ul class="menu_r">
				<li><a href="/shoppingstreet/goIndex">首页</a></li>
	...
	<div class="i_bg">
		<div class="postion">
			<span class="fl">全部 > 美妆个护 > 香水 > </span> <span class="n_ch">
				<span class="fl">品牌：<font>香奈儿</font></span> <a href="#"><img
					src="images/s_close.gif" /></a>
			</span>
		</div>
		<!--Begin 筛选条件 Begin-->
		<div class="content mar_10">
			<table border="0" class="choice"
				style="width: 100%; font-family: '宋体'; margin: 0 auto;"
		...
		<div class="content mar_20">
			<div class="l_history">
				<div class="his_t">
					<span class="fl">浏览历史</span> <span class="fr"><a href="#">清空</a></span>
				</div>
				<ul>
					<li>
						<div class="img">
			...
			<div class="l_list">
				<div class="list_t">
					...
					</span> <span class="fr">共发现<font color="#ff4e00">${fn:length(productList)}</font>件</span>
				</div>
				<div class="list_c">
					...
					<ul class="cate_list">
						<c:forEach items="${productList}" var="product">
							<li>
								<div class="img">
									<a
										href="/shoppingstreet/goProductPage?productId=${product.id }"><img
										src="images/per_1.jpg" width="210" height="185" /></a>
								</div>
								<div class="price">
									<font>￥<span>${product.price }</span></font> &nbsp;
									${product.bonusPoints }R
								</div>
								<div class="name">
									<a
										href="/shoppingstreet/goProductPage?productId=${product.id }">${product.productName }</a>
								</div>
								<div class="carbg">
									<a href="#" class="ss">收藏</a> <a class="j_car"
										onclick="addToCart('${product.id}')">加入购物车</a>
								</div>
							</li>
						</c:forEach>

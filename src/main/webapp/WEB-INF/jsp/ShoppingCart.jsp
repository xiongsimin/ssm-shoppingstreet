...
<body>
	...
	<div class="i_bg">
		...
		<div class="content mar_20">
			<table border="0" class="car_tab"
				...
				<c:if test="${msg!=null }">
					<tr>
						<td colspan="6"><font color="#ff4e00">${msg }</font></td>
					</tr>
				</c:if>
				<c:forEach items="${shoppingCartList }" var="shoppingCart"
					...
					<td>
						...
						</div> <a href="/shoppingstreet/goProductPage?productId=${shoppingCart.productId }">${shoppingCart.productName }</a>
					</td>
					...
					<td align="center">
						<div class="c_num">
							<input type="button" value="" onclick="jianUpdate1(jq(this));"
								...
								value="${shoppingCart.num }" name="" class="car_ipt" /> <input
								type="button" value="" onclick="addUpdate1(jq(this));"
								class="car_btn_2" />
						</div>
					</td>
					<td align="center" style="color: #ff4e00;">￥${shoppingCart.num*shoppingCart.price }</td>
					<td align="center">${shoppingCart.num*shoppingCart.bonusPoints }R</td>
					<td align="center"><a
						onclick="ShowDiv('MyDiv','fade',${shoppingCart.id})">删除</a>&nbsp;
						&nbsp;<a href="#">加入收藏</a></td>
					</tr>
				</c:forEach>
				...
				<tr height="70">
					<td colspan="6"
						...
						class="fr">商品总价：<b style="font-size: 22px; color: #ff4e00;">￥${sessionScope.sumPrice }</b></span>
					</td>
				</tr>
				<tr valign="top" height="150">
					<td colspan="6" align="right"><a href="#"><img
							src="images/buy1.gif" /></a>&nbsp; &nbsp; <a
						href="/shoppingstreet/goShoppingCartTwo"><img
				...
				<div class="notice_c">
					...
					<table border="0" align="center" style="font-size: 16px;"
						...
						<tr height="50" valign="bottom">
							<td><a class="b_sure">确定</a><a
								onclick="CloseDiv('MyDiv','fade')" class="b_buy">取消</a></td>
						</tr>
					</table>
		...
		<div class="btmbg">
			<div class="btm">
				...
				Technical Support: ICT Group <br /> <img src="images/b_1.gif"
	...
	<script>
		function delShoppingCart(shoppingCartId){
			jQuery.ajax({
				url:"/shoppingstreet/delShoppingCart",
				type:"post",
				data:{

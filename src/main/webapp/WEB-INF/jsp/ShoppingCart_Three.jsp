		...
		<div class="content mar_20">
			...
			<div class="warning">
				...
				<c:when test="${msg==null }">
					<table border="0" style="width: 1000px; text-align: center;"
						...
						<tr>
							<td
								...
								&nbsp;您选定的支付方式为: <font color="#ff4e00">${payMethod }</font>；
								&nbsp; &nbsp;您的应付款金额为: <font color="#ff4e00">￥${sumPrice }</font>
							</td>
						</tr>
						<tr>
					...
					<c:otherwise>
						<div style="color:#ff4e00;font-size: 30px;line-hight:30px;padding-left:500px;">${msg }</div>
					</c:otherwise>
				</c:choose>
			</div>
			<!--Begin 银行卡支付 Begin -->

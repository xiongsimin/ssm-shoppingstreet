					...
					<table border="0"
						...
						<tr height="50" valign="top">
							...
							<td><span class="fl" style="font-size: 24px;">注册</span> <span
								class="fr">已有商城账号，<a href="/shoppingstreet/goLogin"
						...
						<tr height="50">
							...
							<td><input type="text" value="" class="l_mem"
								name="inviterName" /></td>
						</tr>
						<tr height="50">
							<td align="right">邀请人ID号 &nbsp;</td>
							<td><input type="text" value="" class="l_num"
								name="inviterId" /></td>
						</tr>
						<tr height="50">
						...
						<tr>
							...
							<td style="font-size: 12px; padding-top: 20px;"><span
								style="font-family: '宋体';" class="fl"> <label
									class="r_rad"><input type="checkbox" name="accept"
										value="1" /></label><label class="r_txt">我已阅读并接受《用户协议》</label>
							</span></td>
						</tr>
						<tr height="60">
							<td>&nbsp;</td>
						...
						<tr><td colspan="2" align="center"><font color="#ff4e00">${msg }</font></td></tr>
					</table>
				</form>
			</div>
		</div>
